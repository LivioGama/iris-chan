// Core principles module (ESM) — mirror of core-principles.js, keep in sync.
...
export const INTENT_PREDICTION_TIERS = Object.freeze([
	Object.freeze({
		tier: 0,
		name: 'EXPLICIT',
		minConfidence: 0.95,
...
export function buildCorePrinciplePreamble() {
	return `
...
export function mapExistingCapability(name) {
