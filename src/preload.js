...
const electronAPI = {
	...
	saveObservation: (observation) => ipcRenderer.invoke(CHANNELS.SAVE_OBSERVATION, observation),
	searchObservations: (query, limit, appFilter) => ipcRenderer.invoke(CHANNELS.SEARCH_OBSERVATIONS, query, limit, appFilter),
	getRecentObservations: (limit, sessionId) => ipcRenderer.invoke(CHANNELS.GET_RECENT_OBSERVATIONS, limit, sessionId),
