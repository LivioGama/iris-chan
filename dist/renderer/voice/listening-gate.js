...
class ListeningGate {
    ...
    _requiredMicVolume() {
        return Math.max(this.options.activationThreshold, this._noiseFloor * this.options.noiseFloorMultiplier + this.options.noiseFloorOffset);
    }
...
exports.ListeningGate = ListeningGate;
