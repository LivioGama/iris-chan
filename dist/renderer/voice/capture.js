...
`;
class AudioCapture extends emitter_js_1.Emitter {
    constructor() {
        super();
        this.ctx = null;
        this.stream = null;
    ...
    async start(retries = 2) {
        ...
        const blob = new Blob([exports.WORKLET_CODE], { type: 'application/javascript' });
