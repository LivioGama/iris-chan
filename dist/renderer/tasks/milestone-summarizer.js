...
exports.summarizeMilestoneLine = summarizeMilestoneLine;
exports.shouldNarrateMilestone = shouldNarrateMilestone;
...
function summarizeMilestoneLine(line = '') {
...
function shouldNarrateMilestone(entry, userContext = {}) {
    if (!entry?.summary)
        return false;
    if (userContext.askedProgress)
        return true;
    if (entry.important)
        return true;
