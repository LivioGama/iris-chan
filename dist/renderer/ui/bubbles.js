...
exports.hideBubbles = void 0;
exports.getBubbleDurationMs = getBubbleDurationMs;
exports.showBubble = showBubble;
exports.showStreamingBubble = showStreamingBubble;
exports.finalizeStreamingBubble = finalizeStreamingBubble;
exports.clearBubbles = clearBubbles;
const hideTimers = new Map();
const streamingBubbles = new Map();
function getBubbleDurationMs(text, lane) {
...
function showBubble(lane, text, { role } = {}) {
 ...
 */
function showStreamingBubble(lane, text, streamId, { role } = {}) {
    const safeLane = ['chat', 'context', 'thinking'].includes(lane) ? lane : 'chat';
    const safeText = String(text || '').trim();
    if (!safeText)
        return;
 ...
 */
function finalizeStreamingBubble(streamId) {
...
exports.hideBubbles = clearBubbles;
