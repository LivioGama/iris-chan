"use strict";
/**
 * Runtime Event Persistence Service
 * Handles persisting telemetry, logs, and important events to Convex.
 */
class RuntimeEventPersistence {
    ...
    async handleEvent(evt) {
        ...
        // Always save the raw event for telemetry/logs
        await this.convexClient.saveRuntimeEvent(serializedEvent, idempotencyKey);
        // Special handling for milestones and task status updates
        ...
        // Special handling for proactive AI suggestions
