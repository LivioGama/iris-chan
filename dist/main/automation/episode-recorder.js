...
class EpisodeRecorder {
    ...
    finishEpisode(taskId, summary = {}) {
        ...
        if (summary.userText)
            episode.userText = summary.userText;
        if (summary.guidanceText)
            episode.guidanceText = summary.guidanceText;
        if (summary.classification)
            episode.classification = summary.classification;
        if (summary.issueSignature)
            episode.issueSignature = summary.issueSignature;
        episode.updatedAt = nowIso();
