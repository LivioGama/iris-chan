...
const vocabularyController = __importStar(require("./controllers/vocabularyController"));
...
const convexController = __importStar(require("./controllers/convexController"));
const kanbanController = __importStar(require("./controllers/kanbanController"));
const taskQueueController = __importStar(require("./controllers/taskQueueController"));
