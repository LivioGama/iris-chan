...
const config = {
    ...
    paths: {
        irisDir: path_1.default.join(os_1.default.homedir(), '.iris'),
        helperSrc: path_1.default.join(__dirname, '..', '..', 'helpers', 'iris-helper.swift'),
        helperBin: path_1.default.join(__dirname, '..', '..', 'helpers', 'iris-helper'),
        srcVocab: path_1.default.join(__dirname, '..', '..', 'data', 'vocabulary.json'),
    },
    messaging: {
